...
There's also a [`help`](https://logtalk.org/handbook/devtools/help.html) tool
...
Lint checks are controlled by a set of [compiler flags](https://logtalk.org/handbook/userman/programming.html#lint-flags).
...
There's also a [`linter_reporter`](https://logtalk.org/handbook/devtools/linter_reporter.html)
that generated machine-readable diagnostics that can be consumed by the
[`sarif`](https://logtalk.org/handbook/devtools/sarif.html) tool for
...
-	Optional highlighting of cyclic relations in directory dependency diagrams, library dependency diagrams, and entity diagrams
...
the [`make`](#make) tool. It suport exporting findings in the SARIF format.
...
-	Force reloading of all loaded files
...
The [`sbom`](https://logtalk.org/handbook/devtools/sbom.html) supports exporting an
application SBOM in CycloneDX and SPDX formats.


## SARIF diagnostic reports

The [`sarif`](https://logtalk.org/handbook/devtools/sarif.html) tool consumes
machine-readable diagnostics generated by other developer tools (such as
[`linter_reporter`](https://logtalk.org/handbook/devtools/linter_reporter.html),
[`dead_code_scanner`](https://logtalk.org/handbook/devtools/dead_code_scanner.html),
[`lgtdoc`](https://logtalk.org/handbook/devtools/lgtdoc.html), and
[`lgtunit`](https://logtalk.org/handbook/devtools/lgtunit.html)) and
outputs SARIF tools for integration with CI/CD pipelines.
...
support for text editors, syntax highlighters (for publishing code), and several IDEs. The "Logtalk for VSCode" extension
...
For convenience, there's also a "Logtalk Extension Pack" that installs all recommended extensions for Logtalk development
