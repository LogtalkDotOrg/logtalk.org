...
-   [Tau Prolog (version 0.3.1 or later)](http://tau-prolog.org)
-   [Trealla Prolog (version 1.20.12 or later)](https://github.com/infradig/trealla) *(experimental)*
...
> [`logtalk-3.53.0.tar.bz2`](files/logtalk-3.53.0.tar.bz2)  
> `31d59739f9bf125dc19b39ef059f0670a7234015b22fdab1918a9bef5c7f32b0` (SHA-256)
...
> [`logtalk-3.53.0.pkg.zip`](files/logtalk-3.53.0.pkg.zip)  
> `31fe127bbff617594af148a9777454bb6c8c1c114cd6b96e6aaab7c4961e322c` (SHA-256)
...
> [`logtalk-3.53.0-1.noarch.rpm`](files/logtalk-3.53.0-1.noarch.rpm)  
> `543dc5ba4dc3ee650ecf96918907198c4b7d6a735b5f6b561b6d240d7ce4d4f2` (SHA-256)

Package installation from the command-line is highly recommended:

```bash
$ sudo rpm -i logtalk-3.53.0-1.noarch.rpm
```
...
> [`logtalk_3.53.0-1_all.deb`](files/logtalk_3.53.0-1_all.deb)  
> `af763d3b8ecd9bb3891d984ffb4395c57f082b97b5acc211be04f771c930e6b6` (SHA-256)

Package installation from the command-line is highly recommended:

```bash
$ sudo dpkg -i logtalk_3.53.0-1_all.deb
```
...
> [`logtalk-3.53.0.exe`](files/logtalk-3.53.0.exe)  
> `865c455e591040d41edda6cd6ecf249bd9743541e913d36f87c50796cae50562` (SHA-256)  
> [VirusTotal scan results](https://www.virustotal.com/gui/url/911cb654a391f53108f5ccaa90e1875dcab2a0389f0a52998bc440a22eedbb9d)
...
> [`logtalk-3.53.0.tgz`](files/swi-prolog/packs/logtalk-3.53.0.tgz)  
> `5dc4c0dbd94ad4fdb00d085f738e2a7d8c04ed017cd6dc3fc8082009ef631e1d` (SHA-256)

In this case, change directory to the download directory, start SWI-Prolog,
and run the query `pack_install('logtalk-3.53.0.tgz').`
...
> [`logtalk-experimental-3.53.0.tgz`](files/swi-prolog/packs/logtalk-experimental-3.53.0.tgz)  
> `1e41de15e42f9e26b3169ff0f42ae70aab5fb802ce4360ca66cc03f842ac999d` (SHA-256)

In this case, change directory to the download directory, start SWI-Prolog,
and run the query `pack_install('logtalk-experimental-3.53.0.tgz').`
...
> [`logtalk-manuals-3.53.0.tgz`](files/logtalk-manuals-3.53.0.tgz)  
> `cb67604958bf7302dbeb532a00672fb62137f32c21de06a6f270e85872728d51` (SHA-256)
